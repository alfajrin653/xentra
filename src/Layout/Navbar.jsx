      ...
      <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
        ...
        <div className={`${isNavbarOpen ? 'block' : 'hidden'} w-full md:block md:w-auto`} id='navbar-dropdown'>
          <ul className='flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-white md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0'>
            <li>
              <HashLink smooth to='/#about' className='block py-2 px-3 text-black hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0'>
                About Us
              </HashLink>
            </li>
            ...
            <li>
              ...
              <HashLink smooth to='/odoo-vs-sap' className='block py-2 px-3 text-black hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0'>
                Odoo vs SAP
              </HashLink>
            </li>
            <li>
            ...
            <li>
              {/* <a href='#client' className='block py-2 px-3 text-black hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0'>
                Client
              </a> */}
              <HashLink smooth to='/#client' className='block py-2 px-3 text-black hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0'>
                Client
              </HashLink>
            </li>
            <li>
              {/* <a href='#contact' className='block py-2 px-3 text-black hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0'>
                Contact Us
              </a> */}
              <HashLink smooth to='/#contact' className='block py-2 px-3 text-black hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0'>
                Contact Us
              </HashLink>
            </li>
          </ul>
